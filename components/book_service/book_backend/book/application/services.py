...
class BookService:
    ...
    def send_message(self, action: str, user_id: int, book_id: int = None) -> None:
        self.publisher.plan(
            Message(
                "create_issue",
    ...
    def create(self, book_info: BookInfo) -> Book:
        ...
        self.send_message("book_create", book_created.id)
        return book_created
    ...
    def update(self, book_info: BookInfo) -> Book:
        ...
        self.send_message("book_update", book_updated.id)
        return book_updated
    ...
    def delete(self, id_: int) -> Book:
        ...
        self.send_message("book_delete", book_deleted.id)
        return book_deleted
    ...
    def take(self, reserve_info: BookReserveInfo) -> Book:
        ...
        if book:
            ...
            self.send_message("book_reserve", reserve_info.user_id, book_taken.id)
            return book_taken
